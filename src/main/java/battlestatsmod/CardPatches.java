...
public class CardPatches {
    ...
    public static class BiteConstructor {
        public static void Postfix(Bite self) {
            self.portrait = createPortrait("battlestatsmod/images/cards/logan-bite.png");
        }
    }
    ...
    public static class DramaticEntranceConstructor {
        public static void Postfix(DramaticEntrance self) {
            self.portrait = createPortrait("battlestatsmod/images/cards/dramatic-logan.png");
        }
    }
    ...
    public static class PurityConstructor {
        public static void Postfix(Purity self) {
            self.portrait = createPortrait("battlestatsmod/images/cards/pure-logan.png");
        }
    }
    ...
    public static class DarkEmbraceConstructor {
        public static void Postfix(DarkEmbrace self) {
            self.portrait = createPortrait("battlestatsmod/images/cards/borkembrace.png");
        }
    }
    ...
    public static class BludgeonConstructor {
        public static void Postfix(Bludgeon self) {
            self.portrait = createPortrait("battlestatsmod/images/cards/blogan.png");
        }
    }
    ...
    public static class FeedConstructor {
        public static void Postfix(Feed self) {
            self.portrait = createPortrait("battlestatsmod/images/cards/logan-feed.png");
        }
    }
    ...
    public static class PiercingWailConstructor {
        public static void Postfix(PiercingWail self) {
            self.portrait = createPortrait("battlestatsmod/images/cards/loganwail.png");
        }
    }
    ...
    public static class loadImageConstructor {
        public static void Postfix(DodgeAndRoll self) {
            self.portrait = createPortrait("battlestatsmod/images/cards/dogeandroll.png");
        }
    }
    ...
    public static class NightmareConstructor {
        public static void Postfix(Nightmare self) {
            self.portrait = createPortrait("battlestatsmod/images/cards/nightmarelogan.png");
        }
    }
    ...
    public static class FootworkConstructor {
        public static void Postfix(Footwork self) {
            self.portrait = createPortrait("battlestatsmod/images/cards/pawwork.png");
        }
    }
    ...
    public static class BiasedCognitionConstructor {
        public static void Postfix(BiasedCognition self) {
            self.portrait = createPortrait("battlestatsmod/images/cards/biaseddog.png");
        }
    }
    ...
    public static class CoolheadedConstructor {
        public static void Postfix(Coolheaded self) {
            self.portrait = createPortrait("battlestatsmod/images/cards/coolheadeddog.png");
        }
    }
        ...
        public static void Postfix(SingleCardViewPopup self) {
            ...
            if (card.cardID.equals("Biased Cognition")) {
                ReflectionHacks.setPrivate(self, SingleCardViewPopup.class, "portraitImg",
                        ImageMaster.loadImage("battlestatsmod/images/cards/biaseddog_p.png"));
            } else if (card.cardID.equals("Dodge and Roll")) {
                ReflectionHacks.setPrivate(self, SingleCardViewPopup.class, "portraitImg",
                        ImageMaster.loadImage("battlestatsmod/images/cards/dogeandroll_p.png"));
            } else if (card.cardID.equals("PiercingWail")) {
                ReflectionHacks.setPrivate(self, SingleCardViewPopup.class, "portraitImg",
                        ImageMaster.loadImage("battlestatsmod/images/cards/loganwail_p.png"));
            } else if (card.cardID.equals("Night Terror")) {
                ReflectionHacks.setPrivate(self, SingleCardViewPopup.class, "portraitImg",
                        ImageMaster.loadImage("battlestatsmod/images/cards/nightmarelogan_p.png"));
            } else if (card.cardID.equals("Footwork")) {
                ReflectionHacks.setPrivate(self, SingleCardViewPopup.class, "portraitImg",
                        ImageMaster.loadImage("battlestatsmod/images/cards/pawwork_p.png"));
            } else if (card.cardID.equals("Bludgeon")) {
                ReflectionHacks.setPrivate(self, SingleCardViewPopup.class, "portraitImg",
                        ImageMaster.loadImage("battlestatsmod/images/cards/blogan_p.png"));
            } else if (card.cardID.equals("Feed")) {
                ReflectionHacks.setPrivate(self, SingleCardViewPopup.class, "portraitImg",
                        ImageMaster.loadImage("battlestatsmod/images/cards/logan-feed_p.png"));
            } else if (card.cardID.equals("Dark Embrace")) {
                ReflectionHacks.setPrivate(self, SingleCardViewPopup.class, "portraitImg",
                        ImageMaster.loadImage("battlestatsmod/images/cards/borkembrace_p.png"));
            } else if (card.cardID.equals("Coolheaded")) {
                ReflectionHacks.setPrivate(self, SingleCardViewPopup.class, "portraitImg",
                        ImageMaster.loadImage("battlestatsmod/images/cards/coolheadeddog_p.png"));
            } else if (card.cardID.equals("Dramatic Entrance")) {
                ReflectionHacks.setPrivate(self, SingleCardViewPopup.class, "portraitImg",
                        ImageMaster.loadImage("battlestatsmod/images/cards/dramatic-logan_p.png"));
            } else if (card.cardID.equals("Purity")) {
                ReflectionHacks.setPrivate(self, SingleCardViewPopup.class, "portraitImg",
                        ImageMaster.loadImage("battlestatsmod/images/cards/pure-logan_p.png"));
            } else if (card.cardID.equals("Bite")) {
                ReflectionHacks.setPrivate(self, SingleCardViewPopup.class, "portraitImg",
                        ImageMaster.loadImage("battlestatsmod/images/cards/logan-bite_p.png"));
            }
        }
    }
    ...
    public static class SoundPatches {
        public static void Postfix(SoundMaster __indent, HashMap<String, Sfx> ___map) {
            ___map.put("LOGAN_BARK", new Sfx("battlestatsmod/sounds/logan-bark.ogg", false));
            ___map.put("LOGAN_BITE", new Sfx("battlestatsmod/sounds/logan-bite.ogg", false));
            ___map.put("LOGAN_WAIL", new Sfx("battlestatsmod/sounds/logan-wail-1.ogg", false));
            ___map.put("ATTACK_PIERCING_WAIL", new Sfx("battlestatsmod/sounds/logan-wail-2.ogg", false));
        }
    }
}
